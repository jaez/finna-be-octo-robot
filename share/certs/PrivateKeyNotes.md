...
unlocked to sign the Dgdollartest2-Qt.app bundle.
...
allowing somebody to distribute a Dgdollartest2-Qt.app or dgdollartest2-qt-setup.exe with a valid
...
that the dgdollartest2-qt.exe file inside the installer had not been tampered with.
