...
**
** Created: Tue Jul 8 09:30:05 2014
...
public:
    ...
    Dgdollartest2AmountField *transactionFee;
    QSpacerItem *horizontalSpacer_1_Main;
    QCheckBox *dgdollartest2AtStartup;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        transactionFee = new Dgdollartest2AmountField(tabMain);
        ...
        dgdollartest2AtStartup = new QCheckBox(tabMain);
        dgdollartest2AtStartup->setObjectName(QString::fromUtf8("dgdollartest2AtStartup"));

        verticalLayout_Main->addWidget(dgdollartest2AtStartup);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        dgdollartest2AtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Dgdollartest2 after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        dgdollartest2AtStartup->setText(QApplication::translate("OptionsDialog", "&Start Dgdollartest2 on system login", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Dgdollartest2 client port on the router. This only works when your router supports UPnP and it is enabled.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Dgdollartest2 network through a SOCKS proxy (e.g. when connecting through Tor).", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Dgdollartest2.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show Dgdollartest2 addresses in the transaction list or not.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
