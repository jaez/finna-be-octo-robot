...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("dgdollartest2-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Dgdollartest2 " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"dgdollartest2tools.com", "dnsseed.dgdollartest2tools.com"},
    {"dgdollartest2pool.org", "dnsseed.dgdollartest2pool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"dgdollartest2tools.com", "testnet-seed.dgdollartest2tools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Dgdollartest2 is probably already running."), addrBind.ToString().c_str());
        else
