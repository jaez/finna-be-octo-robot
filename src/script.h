...
#ifndef H_DGDOLLARTEST2_SCRIPT
#define H_DGDOLLARTEST2_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CDgdollartest2Address
 */
...
public:
    ...
    // Pre-version-0.6, Dgdollartest2 always counted CHECKMULTISIGs
