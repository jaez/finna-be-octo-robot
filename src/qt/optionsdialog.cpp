    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new Dgdollartest2Units(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->dgdollartest2AtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Dgdollartest2."), QMessageBox::Ok);
