...
#ifndef _DGDOLLARTEST2RPC_H_
#define _DGDOLLARTEST2RPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Dgdollartest2 is not connected
...
/**
 * Dgdollartest2 RPC command dispatcher.
 */
class CRPCTable
{
private:
